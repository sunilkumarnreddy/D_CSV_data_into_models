...
from p04_CSV_data.settings import CSV_DIR
from app.models import *
import csv
def data_insert(request):
    with open('C:\\Users\\Jspiders\\Desktop\\74de6\\powerstar\\Scripts\\p04_CSV_DATA\\Business-employment-data-september-2022-quarter-csv.csv','r') as file:
